...
namespace Billar
{
    ...
    {
        Graphics g, gTop, g_p1, g_p2;
        Bitmap bmp, bmp2, p1_bmp, p2_bmp;
        ...
        private void changebutton_Click(object sender, EventArgs e)
        {
            if (player1)
            {
                player1 = false;
                player2 = true;
                sLBL.ForeColor = Color.White;
                sLBL1.ForeColor = Color.Green;
            }else if (player2)
            {
                player2 = false;
                player1 = true;
        ...
        bool didLoad = false;
        public bool didWin1 = false;
        public bool player1 = true;
        public bool player2 = false;
        public bool isplayer1,isplayer2;
        public bool didWin = false;
        public bool player1balls = false;
        public bool player2balls = false;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine(balls2[balls2.Count - 1].vel);
